...
def add_post(request):
    if request.method == 'POST': # user post request koreche
        ...
        if post_form.is_valid(): # post kora data gula amra valid kina check korechi
            post_form.save() # jodi data valid hoi tahole database e save korbo
            return redirect('add_post') # sob thik thakle etake add category ei url e pathiye dibo
