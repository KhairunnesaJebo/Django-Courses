...
class contactForm(forms.Form):
    ...
    MEAL = [('P', 'Pepparoni'), ('M', 'Mashroom'), ('C', 'Chicken')]
...
class studentData(forms.Form):
    ...
    age = forms.IntegerField(validators=[validators.MaxValueValidator(34, message="age must be maximum 35"), validators.MinValueValidator(25, message="age must be at least 25")])
